...
1     
  ...
  const copyPassword = useCallback(()=>{
    ...
    //passwordRef.current?.setSelectionRange(0,4) will select only 4 instead of whole 
    ...
    <>
      <div className="w-full max-w-lg mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700">
        ...
        <div className="flex shadow-md rounded-lg overflow-hidden mb-4">
          ...
          className="px-3 shadow-md outline-none bg-blue-700 text-white shrink-0 py-0.5">Copy</button>
        </div>
